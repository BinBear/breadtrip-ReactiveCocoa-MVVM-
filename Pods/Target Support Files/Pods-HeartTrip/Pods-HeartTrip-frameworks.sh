...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LBXPermission/LBXPermission.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VinBaseComponents/VinBaseComponents.framework"
