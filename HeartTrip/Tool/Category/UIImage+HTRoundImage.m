...
@implementation UIImage (HTRoundImage)

- (UIImage *)HT_setRadius:(CGFloat)radius size:(CGSize)size {
    return [UIImage HT_setHTRadius:HTRadiusMake(radius, radius, radius, radius) image:self size:size borderColor:nil borderWidth:0 backgroundColor:nil withContentMode:UIViewContentModeScaleAspectFill];
}

- (UIImage *)HT_setRadius:(CGFloat)radius size:(CGSize)size contentMode:(UIViewContentMode)contentMode {
    return [UIImage HT_setHTRadius:HTRadiusMake(radius, radius, radius, radius) image:self size:size borderColor:nil borderWidth:0 backgroundColor:nil withContentMode:contentMode];
}

+ (UIImage *)HT_setRadius:(CGFloat)radius size:(CGSize)size borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor {
    return [UIImage HT_setHTRadius:HTRadiusMake(radius, radius, radius, radius) image:nil size:size borderColor:borderColor borderWidth:borderWidth backgroundColor:backgroundColor withContentMode:UIViewContentModeScaleToFill];
}

+ (UIImage *)HT_setHTRadius:(HTRadius)radius image:(UIImage *)image size:(CGSize)size borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor withContentMode:(UIViewContentMode)contentMode {
    ...
    radius = [UIImage transformationHTRadius:radius size:size borderWidth:borderWidth];
...
+ (HTRadius)transformationHTRadius:(HTRadius)radius size:(CGSize)size borderWidth:(CGFloat)borderWidth {
